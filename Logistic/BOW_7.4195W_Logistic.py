...
bow_vectorizer = CountVectorizer(max_features=74195)
...
submission = pd.read_csv('ResultBOW7.4195W.csv', names = ['Id', 'Predicted'])
submission.to_csv('ResultBOW7.4195W.csv', index=0)
save_pickle(lreg, os.path.join('7.4195WBOW.p'))