...
bow_vectorizer = CountVectorizer(max_features=80000)
...
submission = pd.read_csv('ResultBOW8W.csv', names = ['Id', 'Predicted'])
submission.to_csv('ResultBOW8W.csv', index=0)
save_pickle(lreg, os.path.join('8WBOW.p'))